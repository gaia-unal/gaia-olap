...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="{{ url('/home') }}"><b>Gaia</b>Olap</a>
        </div><!-- /.login-logo -->
    ...
    <form action="{{ url('/login') }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <button type="submit" class="btn btn-success btn-block btn-flat">{{ trans('message.buttonsign') }}</button>
            </div><!-- /.col -->
        </div>
    </form>
    ...
    <div class="">
        ...
        <a  class="" href="{{ url('/password/reset') }}">{{ trans('message.forgotpassword') }}</a>
        <br>
        <a class="" href="{{ url('/register') }}" class="text-center">{{ trans('message.registermember') }}</a>
    </div>
